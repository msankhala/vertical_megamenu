...
/**
 * Class VerticalMegaMenuDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from VerticalMegaMenuFormBase. The reason for
 ...
 */
class VerticalMegaMenuDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete vertical_megamenu %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete VerticalMegaMenu');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.vertical_megamenu.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('VerticalMegaMenu %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));
