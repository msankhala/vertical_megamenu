 ...
 */
class VerticalMegaMenuBaseForm extends EntityForm {
  ...
  /**
   * Factory method for VerticalMegaMenuBaseForm.
   *
   ...
   *
   * @return array
   *   An associative array containing the vertical_megamenu add/edit form.
   */
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // annotation on our VerticalMegaMenu class.
    $entity = $this->entity;
  ...
  /**
   * Checks for an existing vertical_megamenu.
   *
  ...
  public function exists($entity_id, array $element, FormStateInterface $form_state) {
    // Use the query factory to build a new vertical_megamenu entity query.
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.vertical_megamenu.list');
  }
